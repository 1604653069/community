...
public class ElecFragment extends Fragment {
    ...
    private List<Pay.PaysBean> paysBeans = new ArrayList<>();
    public ElecFragment(){}
    public ElecFragment(List<Pay.PaysBean> paysBeans){
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.elec_fragment,container,false);
        initView(view);
        initData();
        return view;
    }
    ...
    private void initView(View view) {
        listView = view.findViewById(R.id.elect_list);
    }
